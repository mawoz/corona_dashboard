...
### **Daily cumulative cases by type** (Germany only)
...
This [Coronavirus dashboard: the case of Germany](https://wozniak.blog/wolke/r/coronavirus-dashboard.html) provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Germany. This dashboard is built with R using the R Markdown framework. It is inspired by Antoine Soetewey's [blog](https://statsandr.com){target="_blank"} and was adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin.
...
*Go back to [https://wozniak.blog](https://www.wozniak.blog/)*
